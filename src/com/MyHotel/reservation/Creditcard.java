...
public class Creditcard extends BASESqlInterface {
	...
	static public List<Creditcard> fetchWithJoin(Connection conn, String joindAndWhereStr, String ... params) {
		...
		sb.append("SELECT t.id, t.card_number, t.person_name, t.billing_address, t.expiration_date, t.security_code FROM CreditCard t ");
	...
	static public Creditcard fetchById(Connection conn, String id) {
		String stmt =  "SELECT t.id, t.card_number, t.person_name, t.billing_address, t.expiration_date, t.security_code FROM CreditCard t  WHERE ID = ?";
		PreparedStatement cs = null;
		ResultSet rs = null;
	...
	public  int insertRecord(Connection connection) throws SQLException {
	    PreparedStatement cs = null;
		String stmt = "INSERT into CreditCard(id, card_number, person_name, billing_address, expiration_date, security_code ) VALUES (?,?,?,?,?,?)";
	    try {
