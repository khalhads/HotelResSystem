...
public class Room extends BASESqlInterface {
	...
	static public List<Room> fetchWithJoin(Connection conn, String joindAndWhereStr, String ... params) {
		...
		sb.append("SELECT t.id, t.hotel_id, t.room_no, t.room_type, t.price, t.description, t.floor_no, t.max_people, t.reserved FROM Room t ");
	...
	static public Room fetchById(Connection conn, String id) {
		String stmt =  "SELECT t.id, t.hotel_id, t.room_no, t.room_type, t.price, t.description, t.floor_no, t.max_people, t.reserved FROM Room t  WHERE ID = ?";
		PreparedStatement cs = null;
		ResultSet rs = null;
	...
	public  int insertRecord(Connection connection) throws SQLException {
	    PreparedStatement cs = null;
		String stmt = "INSERT into Room(id, hotel_id, room_no, room_type, price, description, floor_no, max_people, reserved ) VALUES (?,?,?,?,?,?,?,?,?)";
	    try {
	...
	public void printRow(PrintStream out) throws SQLException {
				...
				out.println("reserved = " + m_reserved);
	}
