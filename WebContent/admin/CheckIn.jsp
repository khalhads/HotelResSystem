...
<div class="imgcontainer">
 ...
 <div id='dialog-hotel' title=' Customer Checkin '> 
	 <form action="${pageContext.request.contextPath}/AdminDispatcher">
	 <input type="hidden" name="page-type" value="checkin">
        <fieldset class="ui-widget ui-widget-content ui-corner-all">
			<legend class="ui-widget ui-widget-header ui-corner-all">Customer Checkin</legend>
            <p class='data-entry'> 
            ...
            <button type="submit">Checkin</button>  <button type="button" class="cancelbtn">Cancel</button>
        </fieldset> 
     </form> 
  </div> 
</body>
